...
5. 사용자에게 보여줄 때는 `search-contract.yaml`, `display-queries.sql`, `tool-contract.yaml`의 검색/표시 contract를 우선합니다.
...
| 순위 | 대상 | 이유 |
|---|---|---|
| 1 | 사용자가 직접 저장한 KVIC/KVCA HTML/CSV/XLS snapshot | 정책 리스크가 낮고 공식 화면 근거를 보존할 수 있음 |
