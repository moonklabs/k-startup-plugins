...
| 구성 | 역할 |
|---|---|
| `vc-fund-disclosure-core` | KVIC/KVCA/TIPS 관련 HTML/CSV snapshot, PDF, HWPX import와 정규화, 창업자 guide chunking |
...
- 허용: 저장 HTML/CSV snapshot import, PDF/HWPX import, 로컬 watch folder, 사용자 제스처 기반 browser snapshot import, 창업자 가이드 PDF/HWPX import
